...
# ---- Defaults ---------------------------------------------------------------
XSA_PATH="../stoch_gemm_hybrid/gemm_hybrid_axi/gemm_hybrid_axi.xsa"
...
for f in stoch_gemm_uio.dtso gemm_test_uio_hybrid.c; do
    [[ -f "$SCRIPT_DIR/$f" ]] || \
...
cp "$SCRIPT_DIR/gemm_test_uio_hybrid.c" "$GEMM_APP_FILES/gemm-test.c"
